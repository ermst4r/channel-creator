...
INSERT INTO `mapping` (`id`, `field_name`, `description`, `field_type`, `type_id`, `channel_id`) VALUES
(1, 'category', 'category_path', '1', 1, 1),
(2, 'category_path', 'category_path', '1', 1, 1),
(3, 'color', 'color', '2', 1, 1),
(4, 'color_brite', 'color_brite', '2', 2, 1),
(5, 'ean', 'ean', '2', 1, 2);
